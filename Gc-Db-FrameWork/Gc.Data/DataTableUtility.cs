...
namespace Gc.Data
{
    public class DataTableUtility<Entity>
    {
        ...
        /// <param name="dataRecord"></param>
        /// <returns></returns>
        public static DataTableUtility<Entity> CreateBuilder(DataRow dataRecord)
        {
            DataTableUtility<Entity> dynamicBuilder = new DataTableUtility<Entity>();
