...
namespace Gc.Data
{
    public class DataReaderUtility<T>
    {
        ...
        /// <param name="dataRecord"></param>
        /// <returns></returns>
        public static DataReaderUtility<T> GetInstance(IDataRecord dataRecord)
        {
            DataReaderUtility<T> dynamicBuilder = new DataReaderUtility<T>();
